...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Input Penggunaan Material</title>
			...
			<div id="main_content" class="container-fluid">
				...
				<div class="page-heading">
					...
					<h2 class="page-title muted">
						<i class="icon-th-large"></i>Input Penggunaan Material
					</h2>
					...
					<div class="span7">										
						...
						<div class="well widget">
							...
							<div class="widget-header">
								<h3 class="title">Form Input Penggunaan Material</h3>
							</div>
							<script>
								function hariIni(){
									var today = new Date();
							...
							<form method="post" action="insertmat.php" name="insertmatForm" id="insertmatForm"/>
								<fieldset>
									...
									<input type="text" class="span8" placeholder="Input Jumlah Flexible Pipe" name="jml_flex_pipe" id="jml_flex_pipe"/>
									<hr />
									<label>Tanggal Ambil</label>
									<input type="text" value='<? $today = date("F j, Y");echo $today;?>' class="datePicker" name="tgl_ambil" id="tgl_ambil" placeholder="Tanggal Ambil" />
									<hr />
