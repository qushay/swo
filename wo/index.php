...
<html lang="en">
	...
	<script> 
		$(document).ready(function(){ 
		    ...
		    $("#get_data").load("get_data.php","op=get_all_pelanggan&sto="+sto+"&p="+page);
		    $("#get_pagination").load("get_data.php","op=get_pagination&t=call_instalasi");
		    
		    $("#get_all").click(function(){
		    	$("#get_data").load("get_data.php","op=get_all_pelanggan&sto="+sto+"&p="+page);
		    });
		    $("#get_belum").click(function(){
		    	$("#get_data").load("get_data.php","op=get_belum_pelanggan&sto="+sto+"&p="+page);
		    });
		    $("#get_pending1").click(function(){
		    	$("#get_data").load("get_data.php","op=get_pending1_pelanggan&sto="+sto+"&p="+page);
		    });
		    $("#get_pending2").click(function(){
		    	$("#get_data").load("get_data.php","op=get_pending2_pelanggan&sto="+sto+"&p="+page);
		    });
		    $("#get_notone").click(function(){
		    	$("#get_data").load("get_data.php","op=get_notone_pelanggan&sto="+sto+"&p="+page);
		    });
		    $("#get_ditolak").click(function(){
		    	$("#get_data").load("get_data.php","op=get_ditolak_pelanggan&sto="+sto+"&p="+page);
		    });
		    ...
		    $("#filterSTO").change(function(){
		    	sto= $("#filterSTO").val();
		    	$("#filterPenelepon").load("get_data.php","op=get_penelepon_by_sto&sto="+sto);
		    	$("#get_data").load("get_data.php","op=get_pelanggan_by_sto&sto="+sto+"&p="+page);
		    });
		    $("#filterPenelepon").change(function(){
		    	penelepon=$("#filterPenelepon").val();
		    	$("#get_data").load("get_data.php","op=get_pelanggan_by_sto&sto="+sto+"&penelepon="+penelepon+"&p="+page);
		    });
